...
public class HouseSpec {
    ...
    public HouseSpec() {
        ...
        plan[5][1] = 1; plan[5][2] = 1; plan[5][3] = 1; plan[5][4] = 1; plan[5][5] = 1; plan[5][6] = 1; plan[5][7] = 1; plan[5][8] = 1; plan[5][2] = 1;
                                        plan[6][3] = 1; plan[6][4] = 1; plan[6][5] = 1; plan[6][6] = 1;
                                        plan[7][3] = 1; plan[7][4] = 1; plan[7][5] = 1; plan[7][6] = 1;
                                        plan[8][3] = 1; plan[8][4] = 1; plan[8][5] = 1; plan[8][6] = 1;
